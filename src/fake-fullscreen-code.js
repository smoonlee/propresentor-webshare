...
// Fake fullscreen JS injected into guest pages.
// Replaces the Fullscreen API with a CSS-based visual fake so video fills the
// webview area without triggering Chromium's native fullscreen.
// Consumed by main.js (via executeJavaScript, bypasses CSP) and
// webview-preload.js (via <script> tag injection at document-start).
